      ...
      <div className="relative z-10 w-full max-w-md px-4 flex items-center justify-center">
        <div className="w-full animate-fade-in">
          <div className="text-center space-y-8">
            ...
            <div>
              <h2 className="text-4xl font-bold text-white mb-3 text-balance">Setup Assignment</h2>
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-slate-500">This typically takes a few seconds</p>
