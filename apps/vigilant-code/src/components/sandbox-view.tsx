      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ color: "#fff", fontWeight: 700, fontSize: 14 }}>{fw.label}</span>
            ...
            {PANELS.map((p) => (
              <button
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 600,
                  background: activePanel === p.id ? "rgba(255,255,255,0.1)" : "none",
                  color: activePanel === p.id ? "#fff" : "rgba(255,255,255,0.35)",
        ...
        <SandpackLayout style={{ flex: 1, border: "none", borderRadius: 0 }}>
          ...
          >
            <SandpackPreview style={{ flex: 1, height: "100vh" }} showNavigator showRefreshButton />
          </div>
          <div
            style={{
        ...
        >
          <span style={{ color: "rgba(255,255,255,0.2)", fontSize: 11 }}>
            Template: {resolvedTemplate} · {Object.keys(resolvedFiles).length} file(s)
          </span>
          <span
            style={{
              color: "#22c55e",
