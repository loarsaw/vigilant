...
export const FRAMEWORKS: FrameworkMap = {
  ...
  vue: {
    ...
    features: ["Composition API", "Reactive Data", "Single File Components", "Directives"],
    template: "vue",
  },
  vanilla: {
    label: "Vanilla JS",
    ...
    features: ["Zero Dependencies", "Native DOM API", "ES Modules", "Fastest Load"],
    template: "vanilla",
  },
  svelte: {
    label: "Svelte",
    ...
    features: ["No Virtual DOM", "Compiled Output", "Reactive Declarations", "Tiny Bundle"],
    template: "svelte",
  },
};
